...
class BlogPost(db.Model):
    ...
    parent_user = relationship("User", back_populates="child_blogposts")
...
class User(db.Model, UserMixin):
    ...
    child_blogposts = relationship("BlogPost", back_populates="parent_user")
    child_comments = relationship("Comment", back_populates="parent_user")
...
class Comment(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    author_id = db.Column(db.Integer, db.ForeignKey("users.id"))
    parent_user = relationship("User", back_populates="child_comments")
    form_id = db.Column(db.Integer, db.ForeignKey('blog_posts.id'))
